 ...
 * @param <ID>
 */
public class ModelBaseEntityRepositoryImpl <T, ID > extends SimpleJpaRepository<T, ID> implements ModelBaseEntityRepository<T,ID> {

	
	 private EntityManager entityManager;
	 
	public ModelBaseEntityRepositoryImpl(JpaEntityInformation<T, ?> entityInformation, EntityManager entityManager) {
